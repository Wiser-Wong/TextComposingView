...
public class TextComposingView extends AppCompatTextView {
	...
	@Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int height = heightMode == MeasureSpec.UNSPECIFIED ? textHeight : heightMode == MeasureSpec.EXACTLY ? heightSize : Math.min(textHeight, heightSize);
		int width = widthMode == MeasureSpec.UNSPECIFIED ? textWidth : widthSize;
